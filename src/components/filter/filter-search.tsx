    ...
    <div>
      ...
      <div className="relative w-full ">
        ...
        <input
          ...
          className=" dark:bg-background/10 block w-full rounded-lg border border-solid bg-gray-50/10 p-2  ps-10   text-sm text-gray-900 shadow-sm  outline-none  dark:border-gray-800/50    "
