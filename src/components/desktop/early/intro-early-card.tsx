...
const IntroEarlyCard = () => {
  return (
    <div className="card group relative mx-1 flex min-h-[4rem] max-w-xs flex-shrink-0 cursor-pointer flex-col gap-4 overflow-hidden rounded-3xl border border-solid border-gray-300 dark:border-gray-800 p-8 transition-all   duration-150 ease-in-out  hover:scale-[1.01] hover:border-[1.5px] lg:max-w-md">
