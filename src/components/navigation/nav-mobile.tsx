...
import MobSearch from "./mob-search";
...
const MobileNav = ({ className }: { className?: string }) => {
  ...
  return (
    <>
      ...
      <header
        className={cn(
          "sticky top-0 z-50 w-full  backdrop-blur md:hidden ",
          className,
        )}
      >
        <MarginX>
          {/* Mobile navigation */}
          <nav className="flex h-full w-full items-center justify-between py-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                type="button"
                className=" inline-flex h-8 w-8 items-center justify-center rounded-lg p-1 text-sm text-gray-500 ring-gray-700 ring-offset-2 transition duration-500 ease-in-out hover:ring-2 md:hidden"
                aria-controls="navbar-sticky"
                aria-expanded="false"
              >
                <HamburgerMenuSvg className="h-5 w-5" />
              </button>
